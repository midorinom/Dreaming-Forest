      ...
      <input
        ...
        className={`grow block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-base text-primary-content bg-neutral dark:bg-neutral border-0 border-b-2 appearance-none dark:text-primary-content ${
          isInvalid
            ...
            : "border-accent focus:border-accent dark:border-accent dark:focus:border-accent"
      ...
      <label
        ...
        className={`absolute text-base ${
          isInvalid
            ...
            : "text-accent dark:text-accent peer-focus:text-accent peer-focus:dark:text-accent"
